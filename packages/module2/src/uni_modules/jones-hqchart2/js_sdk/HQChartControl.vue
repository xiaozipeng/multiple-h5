<template>
	...
	<!--  #ifdef  H5 -->
	<div class='kline' v-bind:id='KLineID' v-bind:style="{ width: ChartWidth + 'px', height: ChartHeight + 'px' }" ref='kline'>
	</div>
	<!--  #endif -->

	<!--  #ifdef  MP-WEIXIN -->
	<canvas class="kline" v-bind:id='KLineID' type="2d" v-bind:style="{ width: ChartWidth + 'px', height: ChartHeight + 'px' }"
